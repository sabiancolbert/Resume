    ...
    /* Set As Note */
      ...
      /* Add Number To Cell */
        ...
        if (displayCells[cellNumber] !=-1) {
          cellElement.innerHTML = "<div class='notesContainer'><div id='h1' class='noteHolder'><p class='p1' id='n1"+cellNumber+"'>1</p></div><div id='h2' class='noteHolder'><p class='p2' id='n2"+cellNumber+"'>2</p></div><div id='h3' class='noteHolder'><p class='p3' id='n3"+cellNumber+"'>3</p></div><div id='h4' class='noteHolder'><p class='p4' id='n4"+cellNumber+"'>4</p></div><div id='h5' class='noteHolder'><p class='p5' id='n5"+cellNumber+"'>5</p></div><div id='h6' class='noteHolder'><p class='p6' id='n6"+cellNumber+"'>6</p></div><div id='h7' class='noteHolder'><p class='p7' id='n7"+cellNumber+"'>7</p></div><div id='h8' class='noteHolder'><p class='p8' id='n8"+cellNumber+"'>8</p></div><div id='h9' class='noteHolder'><p class='p9' id='n9"+cellNumber+"'>9</p></div></div>";
        }
