  ...
  if (userCells.includes(cellNumber)) {
    ...
    /* Note Number */
      ...
      /* Add Note To Cell */
        ...
        c("n"+document.getElementById("selectionElement").innerHTML+cellNumber);
        document.getElementById("n"+document.getElementById("selectionElement").innerHTML+cellNumber).style.visibility = "visible";
